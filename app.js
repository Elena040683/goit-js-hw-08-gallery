...
const createImageElement = ({ preview, original, description }) => {
...
galleryRef.addEventListener('click', onItemGalleryClick);
...
btnRef.addEventListener('click', onModalButtonClose);
